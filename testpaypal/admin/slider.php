...
<?
										...
										$filep1 = $_FILES['img1']['tmp_name'];
												...
												if(!empty($filep1))
												{
													...
													if(is_uploaded_file($_FILES["img1"]["tmp_name"]))
													{
														...
														echo $move;
														$AddProduct = mysql_query("INSERT INTO slider(`m_pic`) VALUES('http://qva.ge/slider/$name1')") or die(mysql_error());
													}
												}
	...
	if(isset($_GET['edit']) and !empty($_GET['edit']))
	{
		...
		if(isset($_GET[d]))
		{
			...
			if($d == '1')
			{
				$Up = mysql_query("UPDATE slider SET m_pic='' WHERE id='$id'");
			}
		}
							...
							<div class="row-fluid">
								<div class="span12">
									...
									<div class="table table-custom">
									 ...
									 <div class="input text"><img src="'.$ProductRow3[m_pic].'" height="240" width="200"></div>
										...
										if(isset($_POST[sub]))
										{
												...
												if(!empty($filep1))
												{
													...
													if(is_uploaded_file($_FILES["img1"]["tmp_name"]))
													{
														$move = move_uploaded_file($_FILES["img1"]["tmp_name"], $path."/slider/".$name1);
														echo $path;
														$UpdateProduct = mysql_query("UPDATE slider SET m_pic='http://qva.ge/slider/$name1' WHERE id='".$id."'") or die(mysql_error());
													}
												}
				...
				<div class="widget">
					...
					<div class="widget-body">
						<table class="table table-hover">
						   ...
						   do
						   {
								echo "<tr><td class=''>".$ProductRow[id]."</td><td class=''><img src='".$ProductRow[m_pic]."' width='180' height='90'></td>";
