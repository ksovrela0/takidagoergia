                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                ...
                                <div class="table table-custom">
								 <h3>Добавить Фото</h3> 
								 <br />';
								 echo '<form action="jewelry9.php?add" id="UserAdminEditForm" enctype="multipart/form-data" method="POST" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="PUT"/></div><fieldset>

									<div class="input text"><label for="UserUsername">Картинка</label><input name="m_pic" type="file" accept="image/*" id="UserUsername"/></div>
								 <div class="input text"><label for="UserEmail">Текст Верхний</label><input name="up" type="text" value="" id="UserEmail"/></div>
								 <div class="input text"><label for="UserEmail">Текст Нижний</label><input name="down" type="text" value="" id="UserEmail"/></div>
...
<div class="submit"><input name="sub" class="btn" style="margin-top: 15px;" type="submit" value="Submit"/></div></form>';
								...
								if(isset($_POST['sub']))
								{
									...
									$filep = $_FILES['m_pic']['tmp_name']; 
										...
										$AddCatalog = mysql_query("INSERT INTO slider(`textUP`,`textDOWN`,`img`) VALUES('$textup','$textdown','httpы://takidageorgia.com/img/$name23')") or die(mysql_error());
										if($AddCatalog == true)
										{
											echo '<h2 style="color:green;"><b>Фото '.$name.' Добавлено!!!</b></h2>';
										}
										else
										{
											echo 'Ошибка';
				...
				<div class="widget-body">
                        <div class="row-fluid">
                            <div class="span12">
                                <!--BEGIN TABS-->
                                <div class="table table-custom">
								 <h3>Редактирование Фото <b>'.$ProductRow3[name].'</b></h3> 
								 <br />';
								 echo '<form action="jewelry9.php?edit='.$ProductRow3[id].'" id="UserAdminEditForm" enctype="multipart/form-data" method="POST" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="PUT"/></div><fieldset>
								 <div class="input text"><img src="'.$ProductRow3[img].'" height="240" width="120"></div>
									<div class="input text"><label for="UserUsername">Картинка</label><input name="m_pic" type="file" accept="image/*" id="UserUsername"/></div>
								 <div class="input text"><label for="UserEmail">Текст Верхний</label><input name="up" type="text" value="'.$ProductRow3[textUP].'" id="UserEmail"/></div>
								 <div class="input text"><label for="UserEmail">Текст Нижний</label><input name="down" type="text" value="'.$ProductRow3[textDOWN].'" id="UserEmail"/></div>
...
<div class="submit"><input name="sub" class="btn" style="margin-top: 15px;" type="submit" value="Submit"/></div></form>';
								...
								if(isset($_POST['sub']))
								{
									...
									$filep = $_FILES['m_pic']['tmp_name']; 
											...
											$UpdateProduct = mysql_query("UPDATE slider SET textUP='$textup', textDOWN='$textdown' WHERE id='".$id."'") or die(mysql_error());
											if($UpdateProduct == true)
											{
												echo '<h2 style="color:green;"><b>Фото '.$ProductRow3[name].' Изменено!!!</b></h2>';
												$ftp_server = 'takidageorgia.com';
															$ftp_user_name = 'admin3';
															$ftp_user_pass = 'N12345678';
															$name23 = uniqid();
															...
															{
																$upload = ftp_put($conn_id, 'www/takidageorgia.com/img/'.$name23, $filep, FTP_BINARY);
																$UpdateProduct = mysql_query("UPDATE slider SET img='httpы://takidageorgia.com/img/$name23' WHERE id='".$id."'") or die(mysql_error());
															}
											}
											else
											{
				...
				<div class="widget-body">
                        <div class="row-fluid">
                            <div class="span12">
                                <!--BEGIN TABS-->
                                <div class="table table-custom">
								 <h3>Удалить ФОТО <b>'.$ProductRow2[name].'</b></h3> 
								 <br />
                                    <div class="tab-content">
                                        Are you sure?<br> <a href="jewelry9.php?del='.$_GET[del].'&yes">ДА</a><br><a href="jewelry9.php" style="color:red;">НЕТ</a>                                    </div>
                                </div>
								</div></div></div></div></div></div>';
								if(isset($_GET[yes]))
								{
									...
									if($DelProduct == true)
									{
										echo '<h2 style="color:green;"><b>Фото '.$ProductRow2[name].' Удалено</b></h2>';
									}
								}
...
echo '<div class="row-fluid ">
            <div class="span12">
				...
				<div class="widget-body">
                    ...
                    <a href="#">სია</a>                </li>
                            <li >
                    <a href="jewelry9.php?add">Добавить</a>                </li>
                        </ul>
								 <br />
								 <div class="tab-content">
            ...
            <div class="widget">
                ...
                <div class="widget-body">
                    <table class="table table-hover">
                        ...
                        <tr>
                                                                <th>
                                        <a href="/users.php/index/sort:id/direction:asc" class="desc">Номер</a>                                    </th>
                                                                    <th>
                                        <a href="/users.php/index/sort:username/direction:asc">Фото</a>                                    </th>
										<th>
                                        <a href="/users.php/index/sort:username/direction:asc">Название ВЕРХ</a>                                    </th>
										
                                                                    <th>
                                        <a href="/users.php/index/sort:email/direction:asc">Название ВНИЗ</a>                                    </th>
					   ...
					   do
					   {
						   echo "<tr><td class=''>".$ProductRow[id]."</td><td class=''><img src='".$ProductRow[img]."' width='90' height='90'></td><td class=''>".$ProductRow[textUP]."</td><td class=''>".$ProductRow[textDOWN]."</td>";			
