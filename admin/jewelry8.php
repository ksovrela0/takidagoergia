...
$Product3 = mysql_query("SELECT * FROM georgia WHERE id='".$id."'");
	...
	echo '<div class="row-fluid ">
            <div class="span12">
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                ...
                                <div class="table table-custom">
								 <h3>Редактирование <b>'.$ProductRow3[name].'</b></h3> 
								 <br />';
								 echo '<form action="jewelry8.php?edit='.$ProductRow3[id].'" id="UserAdminEditForm" enctype="multipart/form-data" method="POST" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="PUT"/></div><fieldset>
								 
								 
								 
								 
								 
								 <div class="input text"><label for="UserFirstName">О стране</label><textarea name="ldescr" id="editor2" rows="10" cols="80" type="text">'.$ProductRow3[strana].'</textarea>
								<script>
                ...
                CKEDITOR.replace( "editor2" );
								...
								<div class="input text"><label for="UserFirstName">Регионы</label><textarea name="ldescr2" id="editor3" rows="10" cols="80" type="text">'.$ProductRow3[regioni].'</textarea>
								<script>
                // Replace the <textarea id="editor1"> with a CKEditor
                // instance, using default configuration.
                CKEDITOR.replace( "editor3" );
								...
								<div class="input text"><label for="UserFirstName">Памятка туристу</label><textarea name="ldescr3" id="editor4" rows="10" cols="80" type="text">'.$ProductRow3[tur].'</textarea>
								<script>
                // Replace the <textarea id="editor1"> with a CKEditor
                // instance, using default configuration.
...
<div class="submit"><input  class="btn" style="margin-top: 15px;" type="submit" value="Submit"/></div></form>';
								...
								if(isset($_POST['ldescr']))
								{
									

									$ldescr = $_POST['ldescr'];
									$ldescr2 = $_POST['ldescr2'];
									$ldescr3 = $_POST['ldescr3'];
									if(empty($ldescr) and empty($ldescr2) and empty($ldescr3))
									{
										echo '<h2 style="color:red;"><b>Вы пропустили важные поля!!!</b></h2>';
									}
									else
									{
											$UpdateProduct = mysql_query("UPDATE georgia SET strana='$ldescr', regioni='$ldescr2', tur='$ldescr3' WHERE id='".$id."'") or die(mysql_error());
											if($UpdateProduct == true)
											{
												echo '<h2 style="color:green;"><b> '.$ProductRow3[name].' Изменен!!!</b></h2>';
                ...
                <div class="widget-body">
                    <table class="table table-hover">
                        ...
                        <tr>
                                                                    ...
                                                                    <th>
                                        <a href="/users.php/index/sort:email/direction:asc">О стране</a>                                    </th>
                                                                    <th>
                                        <a href="/users.php/index/sort:email/direction:asc">Регионы</a>                                    </th>
										<th>
                                        <a href="/users.php/index/sort:email/direction:asc">Памятка Туристу</a>                                    </th>
					   ...
					   $Product = mysql_query("SELECT * FROM georgia ORDER BY id DESC") or die(mysql_error());
					   $ProductRow = mysql_fetch_array($Product);
					   do
					   {
						   echo "<td class=''>Текс</td>";		
echo "<td class=''>Текс</td>";	
echo "<td class=''>Текс</td>";							   
	...
	<a href='?edit=$ProductRow[id]' class='btn btn-mini btn-primary'>Редактировать</a> </td>                       </tr>";
					   }
