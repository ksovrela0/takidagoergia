	...
	echo '<div class="row-fluid ">
            <div class="span12">
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                ...
                                <div class="table table-custom">
								 ...
								 <div class="input text"><label for="UserEmail">Название</label><input name="name" type="text" value="" id="UserEmail"/></div>
								 <div class="input text"><label for="UserEmail">Локация</label><input name="loc" type="text" value="" id="UserEmail"/></div>
								 <div class="input text"><label for="UserEmail">Продолжительность</label><input name="dur" type="text" value="" id="UserEmail"/></div>
								 <div class="input text"><label for="UserEmail">Цена</label><input name="price" type="text" value="" id="UserEmail"/></div>
								 
								 
								 <div class="input text"><label for="UserEmail">Тип</label><select name="class">';

									 echo '
									 <option value="1">ПАЛОМНИЧЕСКИЕ ТУРЫ</option>
									 <option value="2">ТУРЫ ПО ГРУЗИИ</option>
									 <option value="3">ЭКСКУРСИИ</option>
									 <option value="4">Туры Грузия-Армения-Азербайджан</option>
									 <option value="10">Школьные туры</option>
									 <option value="11">Групповые туры</option>
                ...
                CKEDITOR.replace( "editor2" );
								 ...
								 <div class="input text"><label for="UserDateOfBirth">Картинка 1(1920X1080)</label><input name="f1" type="file" accept="image/*" id="UserUsername"/></div>
								 
								 <div class="input text"><label for="UserDateOfBirth">Картинка 2(1920X1080)</label><input name="f2" type="file" accept="image/*" id="UserUsername"/></div>
								 
								 <div class="input text"><label for="UserDateOfBirth">Картинка 3(1920X1080)</label><input name="f3" type="file" accept="image/*" id="UserUsername"/></div>
<div class="submit"><input  class="btn" style="margin-top: 15px;" type="submit" value="Submit"/></div></form>';
                                 echo '                                 </div>
								</div></div></div></div></div></div>';
								if(isset($_POST['name']) and isset($_POST['loc']) and isset($_POST['dur']) and isset($_POST['price']) and isset($_POST['ldescr']))
								{
									...
									if(empty($name) or empty($loc) or empty($dur) or empty($price) or empty($ldescr))
									{
									...
									else
									{
										...
										echo $upload;
										$upload1 = ftp_put($conn_id, 'www/takidageorgia.com/img/'.$name1, $filep1, FTP_BINARY);
										$upload2 = ftp_put($conn_id, 'www/takidageorgia.com/img/'.$name2, $filep2, FTP_BINARY);
										$upload3 = ftp_put($conn_id, 'www/takidageorgia.com/img/'.$name3, $filep3, FTP_BINARY);

										// проверяем статус загрузки
										$AddCatalog = mysql_query("INSERT INTO tours(`name`,`price`,`main_pic`,`type`,`duration`,`location`,`text`,`pic1`,`pic2`,`pic3`) VALUES('$name','$price','https://takidageorgia.com/img/$name23','$type','$dur','$loc','$text','https://takidageorgia.com/img/$name1','https://takidageorgia.com/img/$name2','https://takidageorgia.com/img/$name3')") or die(mysql_error());
										if($AddCatalog == true)
										{
											echo '<h2 style="color:green;"><b>Тур '.$name.' Добавлен!!!</b></h2>';
										}
										else
										{
											echo 'Ошибка';
				...
				<div class="widget-body">
                        <div class="row-fluid">
                            <div class="span12">
                                <!--BEGIN TABS-->
                                <div class="table table-custom">
								 <h3>Редактирование Тура <b>'.$ProductRow3[name].'</b></h3> 
								 <br />';
								 ...
								 <div class="input text"><label for="UserEmail">Локация</label><input name="loc" type="text" value="'.$ProductRow3[location].'" id="UserEmail"/></div>
								 <div class="input text"><label for="UserEmail">Продолжительность</label><input name="dur" type="text" value="'.$ProductRow3[duration].'" id="UserEmail"/></div>
								 <div class="input text"><label for="UserEmail">Цена</label><input name="price" type="text" value="'.$ProductRow3[price].'" id="UserEmail"/></div>
...
<div class="submit"><input  class="btn" style="margin-top: 15px;" type="submit" value="Submit"/></div></form>';
								...
								if(isset($_POST['name']) and isset($_POST['loc']) and isset($_POST['dur']) and isset($_POST['price']) and isset($_POST['ldescr']))
								{
									...
									{
											$UpdateProduct = mysql_query("UPDATE tours SET name='$name', type='$type', location='$loc', duration='$dur', price='$price', text='$ldescr' WHERE id='".$id."'") or die(mysql_error());
											if($UpdateProduct == true)
											{
												echo '<h2 style="color:green;"><b>Тур '.$ProductRow3[name].' Изменен!!!</b></h2>';
											}
											else
											{
												echo 'Ошибка';
											...
											{
												$upload = ftp_put($conn_id, 'www/takidageorgia.com/img/'.$name23, $filep, FTP_BINARY);
												$UpdateProduct = mysql_query("UPDATE tours SET main_pic='https://takidageorgia.com/img/$name23' WHERE id='".$id."'") or die(mysql_error());
											}
											if(!empty($filep1))
											{
												$upload1 = ftp_put($conn_id, 'www/takidageorgia.com/img/'.$name1, $filep1, FTP_BINARY);
												$UpdateProduct = mysql_query("UPDATE tours SET pic1='https://takidageorgia.com/img/$name1' WHERE id='".$id."'") or die(mysql_error());
											}
											if(!empty($filep2))
											{
												$upload1 = ftp_put($conn_id, 'www/takidageorgia.com/img/'.$name2, $filep2, FTP_BINARY);
												$UpdateProduct = mysql_query("UPDATE tours SET pic2='https://takidageorgia.com/img/$name2' WHERE id='".$id."'") or die(mysql_error());
											}
											if(!empty($filep3))
											{
												$upload1 = ftp_put($conn_id, 'www/takidageorgia.com/img/'.$name3, $filep3, FTP_BINARY);
												$UpdateProduct = mysql_query("UPDATE tours SET pic3='https://takidageorgia.com/img/$name3' WHERE id='".$id."'") or die(mysql_error());
											}
				...
				<div class="widget-body">
                        <div class="row-fluid">
                            <div class="span12">
                                <!--BEGIN TABS-->
                                <div class="table table-custom">
								 <h3>Удалить тур <b>'.$ProductRow2[name].'</b></h3> 
								 <br />
                                    <div class="tab-content">
                                        Are you sure?<br> <a href="jewelry.php?del='.$_GET[del].'&yes">ДА</a><br><a href="jewelry.php" style="color:red;">НЕТ</a>                                    </div>
                                </div>
								</div></div></div></div></div></div>';
								if(isset($_GET[yes]))
								{
									...
									if($DelProduct == true)
									{
										echo '<h2 style="color:green;"><b>Тур '.$ProductRow2[name].' Удален</b></h2>';
									}
								}
...
echo '<div class="row-fluid ">
            <div class="span12">
				...
				<div class="widget-body">
                    ...
                    <a href="#">სია</a>                </li>
                            <li >
                    <a href="jewelry.php?add">Добавить</a>                </li>
                        </ul>
								 <br />
								 <div class="tab-content">
                ...
                <div class="widget-body">
                    <table class="table table-hover">
                        ...
                        <tr>
										...
										<th>
                                        <a href="/users.php/index/sort:username/direction:asc">Тип</a>                                    </th>
                                                                    <th>
                                        <a href="/users.php/index/sort:email/direction:asc">Цена(Лари)</a>                                    </th>
                                                                    <th>
                                        <a href="/users.php/index/sort:registration_date/direction:asc">Продолжительность</a>                                    </th>
					   ...
					   do
					   {
						   echo "<tr><td class=''>".$ProductRow[id]."</td><td class=''><img src='".$ProductRow[main_pic]."' width='90' height='90'></td><td class=''>".$ProductRow[name]."</td><td class=''>";
						   ...
						   if($ProductRow[type] == 4)
						   {
							   echo 'Туры Грузия-Армения-Азербайджан';
						   }
						   if($ProductRow[type] == 10)
						   {
							   echo 'Школьные туры';
						   }
						   if($ProductRow[type] == 11)
						   {
							   echo 'Групповые туры';
						   }
						   echo "</td><td class=''>".$ProductRow[price]."</td><td class=''>".$ProductRow[duration]."</td>";			
