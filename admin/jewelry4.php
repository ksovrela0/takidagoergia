	...
	<div id="header" class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				<!-- BEGIN LOGO -->
				<a class="brand" href="administratiojewelry4.php">
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                ...
                                <div class="table table-custom">
								 <h3>Добавить Гида</h3> 
								 <br />';
								 echo '<form action="jewelry4.php?add" id="UserAdminEditForm" enctype="multipart/form-data" method="POST" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="PUT"/></div><fieldset>
...
<div class="submit"><input  class="btn" style="margin-top: 15px;" type="submit" value="Submit"/></div></form>';
								...
								if(isset($_POST['name']) and isset($_POST['ldescr']))
								{
									...
									else
									{
										...
										$AddCatalog = mysql_query("INSERT INTO testimonials(`name`,`text`,`main_pic`) VALUES('$name','$ldescr','https://takidageorgia.com/img/$name23')") or die(mysql_error());
										if($AddCatalog == true)
										{
...
$Product3 = mysql_query("SELECT * FROM testimonials WHERE id='".$id."'");
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                ...
                                <div class="table table-custom">
								 ...
								 <br />';
								 echo '<form action="jewelry4.php?edit='.$ProductRow3[id].'" id="UserAdminEditForm" enctype="multipart/form-data" method="POST" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="PUT"/></div><fieldset>
...
<div class="submit"><input  class="btn" style="margin-top: 15px;" type="submit" value="Submit"/></div></form>';
								...
								if(isset($_POST['name']) and isset($_POST['ldescr']))
								{
									...
									{
											$UpdateProduct = mysql_query("UPDATE testimonials SET name='$name', text='$ldescr' WHERE id='".$id."'") or die(mysql_error());
											if($UpdateProduct == true)
											{
												...
												$ftp_server = 'takidageorgia.com';
															...
															{
																$upload = ftp_put($conn_id, 'www/takidageorgia.com/img/'.$name23, $filep, FTP_BINARY);
																$UpdateProduct = mysql_query("UPDATE testimonials SET main_pic='https://takidageorgia.com/img/$name23' WHERE id='".$id."'") or die(mysql_error());
															}
															if(!empty($filep1))
															{
																$upload1 = ftp_put($conn_id, 'www/takidageorgia.com/img/'.$name1, $filep1, FTP_BINARY);
																$UpdateProduct = mysql_query("UPDATE testimonials SET pic1='https://takidageorgia.com/img/$name1' WHERE id='".$id."'") or die(mysql_error());
															}
															if(!empty($filep2))
															{
																$upload1 = ftp_put($conn_id, 'www/takidageorgia.com/img/'.$name2, $filep2, FTP_BINARY);
																$UpdateProduct = mysql_query("UPDATE testimonials SET pic2='https://takidageorgia.com/img/$name2' WHERE id='".$id."'") or die(mysql_error());
															}
															if(!empty($filep3))
															{
																$upload1 = ftp_put($conn_id, 'www/takidageorgia.com/img/'.$name3, $filep3, FTP_BINARY);
																$UpdateProduct = mysql_query("UPDATE testimonials SET pic3='https://takidageorgia.com/img/$name3' WHERE id='".$id."'") or die(mysql_error());
															}
											}
											else
											{
...
$Product2 = mysql_query("SELECT * FROM testimonials WHERE id='".$id."'");
				...
				<div class="widget-body">
                        <div class="row-fluid">
                            <div class="span12">
                                <!--BEGIN TABS-->
                                <div class="table table-custom">
								 <h3>Удалить Отзыв <b>'.$ProductRow2[name].'</b></h3> 
								 <br />
                                    <div class="tab-content">
                                        Are you sure?<br> <a href="jewelry4.php?del='.$_GET[del].'&yes">ДА</a><br><a href="jewelry4.php" style="color:red;">НЕТ</a>                                    </div>
                                </div>
								</div></div></div></div></div></div>';
								if(isset($_GET[yes]))
								{
									$DelProduct = mysql_query("DELETE FROM testimonials WHERE id='".$id."'");
									if($DelProduct == true)
									{
										echo '<h2 style="color:green;"><b>Отзыв '.$ProductRow2[name].' Удален</b></h2>';
									}
								}
...
echo '<div class="row-fluid ">
            <div class="span12">
				...
				<div class="widget-body">
                    ...
                    <a href="#">სია</a>                </li>
                            <li >
                    <a href="jewelry4.php?add">Добавить</a>                </li>
                        </ul>
								 <br />
								 <div class="tab-content">
            ...
            <div class="widget">
                ...
                <div class="widget-body">
                    <table class="table table-hover">
					   ...
					   $Product = mysql_query("SELECT * FROM testimonials ORDER BY id DESC") or die(mysql_error());
