...
$Product3 = mysql_query("SELECT * FROM about WHERE id='".$id."'");
	...
	echo '<div class="row-fluid ">
            <div class="span12">
				...
				<div class="widget-body">
                        <div class="row-fluid">
                            <div class="span12">
                                <!--BEGIN TABS-->
                                <div class="table table-custom">
								 <h3>Редактирование О нас <b>'.$ProductRow3[name].'</b></h3> 
								 <br />';
								 echo '<form action="jewelry3.php?edit='.$ProductRow3[id].'" id="UserAdminEditForm" enctype="multipart/form-data" method="POST" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="PUT"/></div><fieldset>
                ...
                CKEDITOR.replace( "editor2" );
								...
								<div class="input text"><label for="UserEmail">Viber/Whatsapp</label><input name="mob" type="text" value="'.$ProductRow3[mobile].'" id="UserEmail"/></div>
								<div class="input text"><label for="UserEmail">Почта</label><input name="email" type="text" value="'.$ProductRow3[email].'" id="UserEmail"/></div>
								<div class="input text"><label for="UserEmail">Адрес</label><input name="addr" type="text" value="'.$ProductRow3[address].'" id="UserEmail"/></div>
...
<div class="submit"><input  class="btn" style="margin-top: 15px;" type="submit" value="Submit"/></div></form>';
								...
								if(isset($_POST['ldescr']))
								{
									...
									{
											$UpdateProduct = mysql_query("UPDATE about SET text='$ldescr', address='$address', mobile='$mob', email='$email' WHERE id='".$id."'") or die(mysql_error());
											if($UpdateProduct == true)
											{
												echo '<h2 style="color:green;"><b>О нас '.$ProductRow3[name].' Изменен!!!</b></h2>';
                ...
                <div class="widget-body">
                    <table class="table table-hover">
                        ...
                        <tr>
										...
										<th>
                                        <a href="/users.php/index/sort:email/direction:asc">Viber/Whatsapp</a>                                    </th>
										<th>
                                        <a href="/users.php/index/sort:email/direction:asc">Почта</a>                                    </th>
										<th>
                                        <a href="/users.php/index/sort:email/direction:asc">Адрес</a>                                    </th>
					   ...
					   $Product = mysql_query("SELECT * FROM about ORDER BY id DESC") or die(mysql_error());
					   $ProductRow = mysql_fetch_array($Product);
					   do
					   {
						   echo "<td class=''>Текс</td>";		
							echo "<td class=''>".$ProductRow[mobile]."</td>";
							echo "<td class=''>".$ProductRow[email]."</td>";
							echo "<td class=''>".$ProductRow[address]."</td>";						   
