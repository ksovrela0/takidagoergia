                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                ...
                                <div class="table table-custom">
								 ...
								 <br />';
								 echo '<form action="jewelry7.php?add" id="UserAdminEditForm" enctype="multipart/form-data" method="POST" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="PUT"/></div><fieldset>
...
<div class="submit"><input name="sub" class="btn" style="margin-top: 15px;" type="submit" value="Submit"/></div></form>';
								...
								if(isset($_POST['sub']))
								{
									...
									$filep = $_FILES['m_pic']['tmp_name']; 
										...
										// загружаем файл
										$upload = ftp_put($conn_id, 'www/takidageorgia.com/guests/'.$name23, $filep, FTP_BINARY);


										// проверяем статус загрузки
										$AddCatalog = mysql_query("INSERT INTO guests(`pic`) VALUES('http://takidageorgia.com/guests/$name23')") or die(mysql_error());
										if($AddCatalog == true)
										{
											echo '<h2 style="color:green;"><b>Гость '.$name.' Добавлена!!!</b></h2>';
										}
										else
										{
											echo 'Ошибка';
...
$Product3 = mysql_query("SELECT * FROM guests WHERE id='".$id."'");
				...
				<div class="widget-body">
                        <div class="row-fluid">
                            <div class="span12">
                                <!--BEGIN TABS-->
                                <div class="table table-custom">
								 <h3>Редактирование Гостя <b>'.$ProductRow3[name].'</b></h3> 
								 <br />';
								 echo '<form action="jewelry7.php?edit='.$ProductRow3[id].'" id="UserAdminEditForm" enctype="multipart/form-data" method="POST" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="PUT"/></div><fieldset>
								 <div class="input text"><img src="'.$ProductRow3[pic].'" height="240" width="120"></div>
									<div class="input text"><label for="UserUsername">Картинка</label><input name="m_pic" type="file" accept="image/*" id="UserUsername"/></div>
<div class="submit"><input name="sub" class="btn" style="margin-top: 15px;" type="submit" value="Submit"/></div></form>';
                                 echo '                                 </div>
								</div></div></div></div></div></div>';
								...
								if(isset($_POST['sub']))
								{
									$filep = $_FILES['m_pic']['tmp_name']; 
											...
											{
												$upload = ftp_put($conn_id, 'www/takidageorgia.com/guests/'.$name23, $filep, FTP_BINARY);
												$UpdateProduct = mysql_query("UPDATE guests SET pic='http://takidageorgia.com/guests/$name23' WHERE id='".$id."'") or die(mysql_error());
...
$Product2 = mysql_query("SELECT * FROM guests WHERE id='".$id."'");
				...
				<div class="widget-body">
                        <div class="row-fluid">
                            <div class="span12">
                                <!--BEGIN TABS-->
                                <div class="table table-custom">
								 <h3>Удалить Гостя <b>'.$ProductRow2[name].'</b></h3> 
								 <br />
                                    <div class="tab-content">
                                        Are you sure?<br> <a href="jewelry7.php?del='.$_GET[del].'&yes">ДА</a><br><a href="jewelry7.php" style="color:red;">НЕТ</a>                                    </div>
                                </div>
								</div></div></div></div></div></div>';
								if(isset($_GET[yes]))
								{
									$DelProduct = mysql_query("DELETE FROM guests WHERE id='".$id."'");
									if($DelProduct == true)
									{
										echo '<h2 style="color:green;"><b>Гость '.$ProductRow2[name].' Удален</b></h2>';
									}
								}
...
echo '<div class="row-fluid ">
            <div class="span12">
				...
				<div class="widget-body">
                    ...
                    <a href="#">სია</a>                </li>
                            <li >
                    <a href="jewelry7.php?add">Добавить</a>                </li>
                        </ul>
								 <br />
								 <div class="tab-content">
            ...
            <div class="widget">
                ...
                <div class="widget-body">
                    <table class="table table-hover">
					   ...
					   $Product = mysql_query("SELECT * FROM guests ORDER BY id DESC") or die(mysql_error());
					   $ProductRow = mysql_fetch_array($Product);
					   do
					   {
						   echo "<tr><td class=''>".$ProductRow[id]."</td><td class=''><img src='".$ProductRow[pic]."' width='180' height='180'></td>";			
