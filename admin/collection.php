...
$(document).ready(function(){	
	...
	<meta charset="utf-8" />
    <title>Jewerly Collections</title>
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                ...
                                <div class="table table-custom">
								 <h3>Removing collection <b>'.$UsersRow4[catname].'</b></h3> 
								 <br />
                                    <div class="tab-content">
                                        Are you sure?<br> <a href="collection.php?del='.$_GET[del].'&yes">Yes, of course</a><br><a href="collection.php" style="color:red;">No</a>                                    </div>
                                </div>
								</div></div></div></div></div></div>';
								if(isset($_GET['yes']))
								{
									$DelUser = mysql_query("DELETE FROM collections WHERE id='".$_GET[del]."'");
									if($DelUser == true)
									{
										echo '<h2 style="color:green;"><b>collection '.$UsersRow4[catname].' is deleted</b></h2>';
									}
								}
}
                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                ...
                                <div class="table table-custom">
								 ...
								 <br />';
								 echo '<form action="collection.php?add" id="UserAdminEditForm" enctype="multipart/form-data" method="POST" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="PUT"/></div><fieldset><div class="input text"><label for="UserUsername"></label><input name="name" type="text" id="UserUsername"/></div>
<div class="submit"><input  class="btn" style="margin-top: 15px;" type="submit" value="Submit"/></div></form>';
								...
								if(isset($_POST['name']))
								{
									...
									{
										$addCollection = mysql_query("INSERT INTO collections(`catname`) VALUES('$name')") or die(mysql_error());
										if($addCollection == true)
										{
											echo '<h2 style="color:green;"><b>new collection created</b></h2>';
										}
										else
										{
											echo 'Problem';
...
$Collection3 = mysql_query("SELECT * FROM collections WHERE id='".$id."'");
...
<div class="submit"><input  class="btn" style="margin-top: 15px;" type="submit" value="Submit"/></div></form>';
								...
								if(isset($_POST['name']))
								{
									...
									{
										$UpdateCollection = mysql_query("UPDATE collections SET catname='$name' WHERE id='".$id."'") or die(mysql_error());
										if($UpdateCollection == true)
										{
											echo '<h2 style="color:green;"><b>Collection With ID '.$CollectionRow3[id].' was edited</b></h2>';
										}
										else
										{
											echo 'Problem';
...
echo '<div class="row-fluid ">
            <div class="span12">
				...
				<div class="widget-body">
                    ...
                    <a href="#">List</a>                </li>
                            <li >
                    <a href="collection.php?add">Add</a>                </li>
                        </ul>
								 <br />
								 <div class="tab-content">
            ...
            <div class="widget">
                ...
                <div class="widget-body">
                    <table class="table table-hover">
                        ...
                        <tr>
                                                                <th>
                                        <a href="/users.php/index/sort/direction:asc" class="desc">Collections</a>                                    </th>
					   ...
					   $Collection = mysql_query("SELECT * FROM collections ORDER BY id DESC") or die(mysql_error());
					   $CollectionRow = mysql_fetch_array($Collection);
					   do
					   {
						  echo "<td class=''>".$CollectionRow[catname]."</td>   <td style='min-width: 190px;' class='actions'>
	<a href='?edit=$CollectionRow[id]' class='btn btn-mini btn-primary'>Edit</a> <a href='?del=$CollectionRow[id]' class='btn btn-mini btn-primary'>Delete</a>   </td>                       </tr>";
					   }
