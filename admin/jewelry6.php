                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                ...
                                <div class="table table-custom">
								 <h3>Добавить Гида</h3> 
								 <br />';
								 echo '<form action="jewelry6.php?add" id="UserAdminEditForm" enctype="multipart/form-data" method="POST" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="PUT"/></div><fieldset>
								 ...
								 <div class="input text"><label for="UserEmail">Тип</label><select name="type">';

									 echo '
									 <option value="0">Гид</option>
...
<div class="submit"><input  class="btn" style="margin-top: 15px;" type="submit" value="Submit"/></div></form>';
								...
								if(isset($_POST['name']) and isset($_POST['ldescr']))
								{
									...
									else
									{
										...
										$AddCatalog = mysql_query("INSERT INTO guids(`name`,`text`,`main_pic`,type) VALUES('$name','$ldescr','https://takidageorgia.com/img/$name23','$_POST[type]')") or die(mysql_error());
										if($AddCatalog == true)
										{
											echo '<h2 style="color:green;"><b>Гид '.$name.' Добавлен!!!</b></h2>';
										}
										else
										{
											echo 'Ошибка';
...
$Product3 = mysql_query("SELECT * FROM guids WHERE id='".$id."'");
				...
				<div class="widget-body">
                        <div class="row-fluid">
                            <div class="span12">
                                <!--BEGIN TABS-->
                                <div class="table table-custom">
								 <h3>Редактирование Гида <b>'.$ProductRow3[name].'</b></h3> 
								 <br />';
								 echo '<form action="jewelry6.php?edit='.$ProductRow3[id].'" id="UserAdminEditForm" enctype="multipart/form-data" method="POST" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="PUT"/></div><fieldset>
...
<div class="submit"><input  class="btn" style="margin-top: 15px;" type="submit" value="Submit"/></div></form>';
								...
								if(isset($_POST['name']) and isset($_POST['ldescr']))
								{
									...
									{
											$UpdateProduct = mysql_query("UPDATE guids SET name='$name', text='$ldescr', type='$_POST[type]' WHERE id='".$id."'") or die(mysql_error());
											if($UpdateProduct == true)
											{
												echo '<h2 style="color:green;"><b>Гид '.$ProductRow3[name].' Изменен!!!</b></h2>';
												$ftp_server = 'takidageorgia.com';
															$ftp_user_name = 'admin3';
															$ftp_user_pass = 'N12345678';
															$name23 = uniqid();
															...
															{
																$upload = ftp_put($conn_id, 'www/takidageorgia.com/img/'.$name23, $filep, FTP_BINARY);
																$UpdateProduct = mysql_query("UPDATE guids SET main_pic='https://takidageorgia.com/img/$name23' WHERE id='".$id."'") or die(mysql_error());
															}
											}
											else
											{
...
$Product2 = mysql_query("SELECT * FROM guids WHERE id='".$id."'");
				...
				<div class="widget-body">
                        <div class="row-fluid">
                            <div class="span12">
                                <!--BEGIN TABS-->
                                <div class="table table-custom">
								 <h3>Удалить Гида <b>'.$ProductRow2[name].'</b></h3> 
								 <br />
                                    <div class="tab-content">
                                        Are you sure?<br> <a href="jewelry6.php?del='.$_GET[del].'&yes">ДА</a><br><a href="jewelry6.php" style="color:red;">НЕТ</a>                                    </div>
                                </div>
								</div></div></div></div></div></div>';
								if(isset($_GET[yes]))
								{
									$DelProduct = mysql_query("DELETE FROM guids WHERE id='".$id."'");
									if($DelProduct == true)
									{
										echo '<h2 style="color:green;"><b>Гид '.$ProductRow2[name].' Удален</b></h2>';
									}
								}
...
echo '<div class="row-fluid ">
            <div class="span12">
				...
				<div class="widget-body">
                    ...
                    <a href="#">სია</a>                </li>
                            <li >
                    <a href="jewelry6.php?add">Добавить</a>                </li>
                        </ul>
								 <br />
								 <div class="tab-content">
            ...
            <div class="widget">
                ...
                <div class="widget-body">
                    <table class="table table-hover">
					   ...
					   $Product = mysql_query("SELECT * FROM guids ORDER BY id DESC") or die(mysql_error());
