                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                ...
                                <div class="table table-custom">
								 ...
								 <br />';
								 echo '<form action="jewelry5.php?add" id="UserAdminEditForm" enctype="multipart/form-data" method="POST" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="PUT"/></div><fieldset>
...
<div class="submit"><input name="sub" class="btn" style="margin-top: 15px;" type="submit" value="Submit"/></div></form>';
								...
								if(isset($_POST['sub']))
								{
									...
									$filep = $_FILES['m_pic']['tmp_name']; 
										...
										// загружаем файл
										$upload = ftp_put($conn_id, 'www/takidageorgia.com/cars/'.$name23, $filep, FTP_BINARY);


										// проверяем статус загрузки
										$AddCatalog = mysql_query("INSERT INTO cars(`pic`) VALUES('http://takidageorgia.com/cars/$name23')") or die(mysql_error());
										if($AddCatalog == true)
										{
											echo '<h2 style="color:green;"><b>Машина '.$name.' Добавлена!!!</b></h2>';
										}
										else
										{
											echo 'Ошибка';
				...
				<div class="widget-body">
                        <div class="row-fluid">
                            <div class="span12">
                                <!--BEGIN TABS-->
                                <div class="table table-custom">
								 <h3>Редактирование Машину <b>'.$ProductRow3[name].'</b></h3> 
								 <br />';
								 echo '<form action="jewelry5.php?edit='.$ProductRow3[id].'" id="UserAdminEditForm" enctype="multipart/form-data" method="POST" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="PUT"/></div><fieldset>
...
<div class="submit"><input name="sub" class="btn" style="margin-top: 15px;" type="submit" value="Submit"/></div></form>';
								...
								if(isset($_POST['sub']))
								{
									$filep = $_FILES['m_pic']['tmp_name']; 
											...
											{
												$upload = ftp_put($conn_id, 'www/takidageorgia.com/cars/'.$name23, $filep, FTP_BINARY);
												$UpdateProduct = mysql_query("UPDATE cars SET pic='http://takidageorgia.com/cars/$name23' WHERE id='".$id."'") or die(mysql_error());
				...
				<div class="widget-body">
                        <div class="row-fluid">
                            <div class="span12">
                                <!--BEGIN TABS-->
                                <div class="table table-custom">
								 <h3>Удалить машину <b>'.$ProductRow2[name].'</b></h3> 
								 <br />
                                    <div class="tab-content">
                                        Are you sure?<br> <a href="jewelry5.php?del='.$_GET[del].'&yes">ДА</a><br><a href="jewelry.php" style="color:red;">НЕТ</a>                                    </div>
                                </div>
								</div></div></div></div></div></div>';
								if(isset($_GET[yes]))
								{
									...
									if($DelProduct == true)
									{
										echo '<h2 style="color:green;"><b>Машина '.$ProductRow2[name].' Удалена</b></h2>';
									}
								}
...
echo '<div class="row-fluid ">
            <div class="span12">
				...
				<div class="widget-body">
                    ...
                    <a href="#">სია</a>                </li>
                            <li >
                    <a href="jewelry5.php?add">Добавить</a>                </li>
                        </ul>
								 <br />
								 <div class="tab-content">
