                        ...
                        <div class="row-fluid">
                            <div class="span12">
                                ...
                                <div class="table table-custom">
								 ...
								 <br />';
								 echo '<form action="jewelry2.php?add" id="UserAdminEditForm" enctype="multipart/form-data" method="POST" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="PUT"/></div><fieldset>
...
<div class="submit"><input  class="btn" style="margin-top: 15px;" type="submit" value="Submit"/></div></form>';
								...
								if(isset($_POST['name']) and isset($_POST['loc']) and isset($_POST['dur']) and isset($_POST['price']) and isset($_POST['ldescr']))
								{
									...
									else
									{
										...
										$AddCatalog = mysql_query("INSERT INTO hotels(`name`,`price`,`main_pic`,`duration`,`location`,`text`,`pic1`,`pic2`,`pic3`) VALUES('$name','$price','httpы://takidageorgia.com/img/$name23','$dur','$loc','$ldescr','httpы://takidageorgia.com/img/$name1','httpы://takidageorgia.com/img/$name2','httpы://takidageorgia.com/img/$name3')") or die(mysql_error());
										if($AddCatalog == true)
										{
											echo '<h2 style="color:green;"><b>Гостиница '.$name.' Добавлен!!!</b></h2>';
										}
										else
										{
											echo 'Ошибка';
				...
				<div class="widget-body">
                        <div class="row-fluid">
                            <div class="span12">
                                <!--BEGIN TABS-->
                                <div class="table table-custom">
								 <h3>Редактирование Гостиницы <b>'.$ProductRow3[name].'</b></h3> 
								 <br />';
...
<div class="submit"><input  class="btn" style="margin-top: 15px;" type="submit" value="Submit"/></div></form>';
								...
								if(isset($_POST['name']) and isset($_POST['loc']) and isset($_POST['dur']) and isset($_POST['price']) and isset($_POST['ldescr']))
								{
									...
									{
											$UpdateProduct = mysql_query("UPDATE hotels SET name='$name', location='$loc', duration='$dur', price='$price', text='$ldescr' WHERE id='".$id."'") or die(mysql_error());
											...
											{
												$upload = ftp_put($conn_id, 'www/takidageorgia.com/img/'.$name23, $filep, FTP_BINARY);
												$UpdateProduct = mysql_query("UPDATE hotels SET main_pic='httpы://takidageorgia.com/img/$name23' WHERE id='".$id."'") or die(mysql_error());
											}
											if(!empty($filep1))
											{
												$upload1 = ftp_put($conn_id, 'www/takidageorgia.com/img/'.$name1, $filep1, FTP_BINARY);
												$UpdateProduct = mysql_query("UPDATE hotels SET pic1='httpы://takidageorgia.com/img/$name1' WHERE id='".$id."'") or die(mysql_error());
											}
											if(!empty($filep2))
											{
												$upload1 = ftp_put($conn_id, 'www/takidageorgia.com/img/'.$name2, $filep2, FTP_BINARY);
												$UpdateProduct = mysql_query("UPDATE hotels SET pic2='httpы://takidageorgia.com/img/$name2' WHERE id='".$id."'") or die(mysql_error());
											}
											if(!empty($filep3))
											{
												$upload1 = ftp_put($conn_id, 'www/takidageorgia.com/img/'.$name3, $filep3, FTP_BINARY);
												$UpdateProduct = mysql_query("UPDATE hotels SET pic3='httpы://takidageorgia.com/img/$name3' WHERE id='".$id."'") or die(mysql_error());
											}
				...
				<div class="widget-body">
                        <div class="row-fluid">
                            <div class="span12">
                                <!--BEGIN TABS-->
                                <div class="table table-custom">
								 <h3>Удалить Гостиницу <b>'.$ProductRow2[name].'</b></h3> 
								 <br />
                                    <div class="tab-content">
                                        Are you sure?<br> <a href="jewelry2.php?del='.$_GET[del].'&yes">ДА</a><br><a href="jewelry2.php" style="color:red;">НЕТ</a>                                    </div>
                                </div>
								</div></div></div></div></div></div>';
								if(isset($_GET[yes]))
								{
...
echo '<div class="row-fluid ">
            <div class="span12">
				...
				<div class="widget-body">
                    ...
                    <a href="#">სია</a>                </li>
                            <li >
                    <a href="jewelry2.php?add">Добавить</a>                </li>
                        </ul>
								 <br />
								 <div class="tab-content">
            ...
            <div class="widget">
                ...
                <div class="widget-body">
                    <table class="table table-hover">
					   ...
					   do
					   {
						   echo "<tr><td class=''>".$ProductRow[id]."</td><td class=''><img src='".$ProductRow[main_pic]."' width='90' height='90'></td><td class=''>".$ProductRow[name]."</td><td class=''>".$ProductRow[price]."</td><td class=''>".$ProductRow[duration]."</td>";			
